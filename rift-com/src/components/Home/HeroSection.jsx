    ...
    <div className="w-full px-[10%] py-[90px]">
      <Row className="w-full items-center justify-between">
        <div className="w-[46%]">
          ...
          <button className=" p-3 text-white bg-black text-[20px]  font-medium mt-[50px]">
            Shop Now
          </button>
        </div>
        <div className="w-[46%]">
          <div className="w-[424px] h-[542px] relative">
            <img
              ...
              alt="Hero"
            />
            <div className="absolute  w-full h-full rounded-tl-[160px] rounded-br-[160px] border-[2px] border-[#00000040] top-[20px] left-[18px] -z-[1]" />
          </div>
        </div>
      </Row>
    </div>
